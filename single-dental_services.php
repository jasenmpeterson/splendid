...
if ($smarty->templateExists(THEME_DIR . '/smarty_templates/pages/single-dental-services.tpl')) :

    // display template :

    $smarty->display(THEME_DIR . '/smarty_templates/pages/single-dental-services.tpl');
